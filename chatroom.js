...
function getText() {
        ...
        if (is_start && counter == 0) {
                var str = "Hello! Welcome to our symptom checker.Please answer yes or no to our questions and hit the SEND button.Are you expereincing trouble breathing, persistent pain or pressure in the chest, new confusion, inability to wake or saty awake, Bluish lips or face?";
                robot.innerHTML = str;
